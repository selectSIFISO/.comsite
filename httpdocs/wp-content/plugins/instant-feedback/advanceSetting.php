...
?>	
<span><input class="mye_chk" type="checkbox" id="home" name="postType" <?php echo $eff_isOnHome; ?>/>Home Page <a class="m_hp" href="<?php echo $hostString; ?>/support?type=shortcode#homeShortCode" target="_blank">(?)</a></span>
