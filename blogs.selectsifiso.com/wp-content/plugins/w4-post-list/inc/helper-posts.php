	...
	public static function get_shortcodes( $shortcodes )
	{
		$_shortcodes = array(
			...
			'post_type' => array(
				...
				'desc' 		=> '<strong>'. __('Output', W4PL_TD) .'</strong>: post type'
			),
			'post_type_label' => array(
				'group' 	=> 'Post', 
				'callback' 	=> array('W4PL_Helper_Posts', 'post_type_label'),
				'desc' 		=> '<strong>'. __('Output', W4PL_TD) .'</strong>: post type label'
			),
			'post_status' => array(
				'group' 	=> 'Post', 
				'callback' 	=> array('W4PL_Helper_Posts', 'post_status'),
				'desc' 		=> '<strong>'. __('Output', W4PL_TD) .'</strong>: post status'
			),
			'post_status_label' => array(
				'group' 	=> 'Post', 
				'callback' 	=> array('W4PL_Helper_Posts', 'post_status_label'),
				'desc' 		=> '<strong>'. __('Output', W4PL_TD) .'</strong>: post status label'
			),
			'post_number' => array(
				'group' 	=> 'Post', 
